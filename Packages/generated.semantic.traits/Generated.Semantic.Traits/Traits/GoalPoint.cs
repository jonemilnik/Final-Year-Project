...
namespace Generated.Semantic.Traits
{
    ...
    [AddComponentMenu("Semantic/Traits/GoalPoint (Trait)")]
    [RequireComponent(typeof(SemanticObject))]
    public partial class GoalPoint : MonoBehaviour, ITrait
    {
        ...
        public void Convert(Entity entity, EntityManager destinationManager, GameObjectConversionSystem _)
        {
            ...
            if (!destinationManager.HasComponent(entity, typeof(GoalPointData)))
            {
                destinationManager.AddComponent<GoalPointData>(entity);
            }
        }
        ...
        void OnDestroy()
        {
            ...
            {
                m_EntityManager.RemoveComponent<GoalPointData>(m_Entity);
        ...
        void OnDrawGizmos()
        {
            TraitGizmos.DrawGizmoForTrait(nameof(GoalPointData), gameObject,null);
        }
#endif
    }
}
